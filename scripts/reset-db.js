        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma.processedMessage.deleteMany({})];
                case 1:
                    _a.sent();
                    console.log("Deleting conversation messages...");
                    return [4 /*yield*/, prisma.conversationMessage.deleteMany({})];
                case 2:
                    _a.sent();
                    console.log("Deleting agent states...");
                    return [4 /*yield*/, prisma.agentState.deleteMany({})];
                case 3:
                    _a.sent();
                    console.log("Resetting borrower statuses...");
                    return [4 /*yield*/, prisma.borrower.updateMany({
                            data: { status: "PENDING" },
                        })];
                case 4:
                    _a.sent();
...
reset().catch(function (err) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
